/*
SPDX-FileCopyrightText: 2023 SAP SE or an SAP affiliate company and nginx-ingress-controller-cop contributors
...
import (
	...
	operatorv1alpha1 "github.com/sap/nginx-ingress-controller-cop/api/v1alpha1"
	"github.com/sap/nginx-ingress-controller-cop/internal/generator"
)

const Name = "nginx-ingress-controller-cop.cs.sap.com"
...
func (o *Operator) GetUncacheableTypes() []client.Object {
	return []client.Object{&operatorv1alpha1.NginxIngressController{}}
}
...
func (o *Operator) Setup(mgr ctrl.Manager, discoveryClient discovery.DiscoveryInterface) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.NginxIngressController](
		o.options.Name,
		mgr.GetClient(),
		discoveryClient,
